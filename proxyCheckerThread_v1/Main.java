...
//                    System.out.print((char) i);//кастуем и выводим символ
                    resultIp += (char) i;//Сохраняем в строку любые другие смволы прочитанные из файла
                }
//String s = String.valueOf(new char[]{10,13,9}); - можно использовать, чтобы пустые строки удалять не вручную, а програмно
//                resultIp="";
...
class ProxyChecker extends Thread {
    private String ip;
    private int port;
